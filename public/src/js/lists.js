$(document).ready(function() {
	...
	$('.rm_theme').on('click', {path:'/auth/themes/remove/main', description: 'Удалить тему?'}, remove);
	$('.rm_theme_sub').on('click', {path:'/auth/themes/remove/sub', description: 'Удалить подтему?'}, remove);
